...
// console.log("updated",programmingLanguage)
// //2.4
...
// challege 2
let properties=game.scored.entries()
console.log(properties)
for(const [key,x] of properties){
  console.log(`Goal ${key+1}:${x}`)
}